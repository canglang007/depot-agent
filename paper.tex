...
\fancyhead[C]{\small  Depot：面向代码生成Agent的按需依赖解析系统}
\fancyfoot[C]{\thepage}
...
\hline
韩可可 & 第3章（问题定义）、第4.3-4.6节（解析器/安装器/执行器/缓存） & 问题形式化与Gap分析、系统核心引擎设计、实验方案设计 \\
\hline
刘卓明 & 第4.1/4.7/4.8节（架构/创新/反馈）、第5章（实验）、第6章（工程化实现与开源）、第7-8章（讨论/结论） & 论文框架设计、实验数据分析与撰写、工程化实现（CLI/SDK/PyPI/Skill）、论文统稿 \\
\bottomrule
\end{tabular}
\end{table}

...
OpenAI.
\newblock Code Interpreter[EB/OL]. (2023). https://platform.openai.com/docs/assistants/tools/code-interpreter.

\bibitem{e2b2024}
E2B.
\newblock Secure Sandboxed Cloud Environments for AI Agents[EB/OL]. (2024). https://e2b.dev/docs.

\bibitem{openinterpreter2023}
Killian L.
\newblock Open Interpreter: Let Language Models Run Code on Your Computer[EB/OL]. (2023). https://github.com/OpenInterpreter/open-interpreter.

\bibitem{autogpt2024}
Significant Gravitas.
\newblock AutoGPT: Build and Use AI Agents[EB/OL]. (2024). https://github.com/Significant-Gravitas/AutoGPT.

\bibitem{anthropic2025claude}
Anthropic.
\newblock Claude Code: An Agentic Coding Tool[EB/OL]. (2025). https://docs.anthropic.com/en/docs/claude-code.

\bibitem{google2024aistudio}
Google.
\newblock Google AI Studio: Code Execution Overview[EB/OL]. (2024). https://aistudio.google.com.

\bibitem{jimenez2024sweagent}
YANG J, JIMENEZ C E, WETTIG A, et al.
\newblock SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering[C]//Proceedings of NeurIPS 2024. 2024.

\bibitem{yang2024swebench}
JIMENEZ C E, YANG J, WETTIG A, et al.
\newblock SWE-bench: Can Language Models Resolve Real-World GitHub Issues?[C]//Proceedings of ICLR 2024. 2024.

\bibitem{guo2024aider}
GAUTHIER P.
\newblock Aider: AI Pair Programming in Your Terminal[EB/OL]. (2024). https://github.com/Aider-AI/aider.

\bibitem{cognition2024devin}
Cognition AI.
\newblock Devin: The First AI Software Engineer[EB/OL]. (2024). https://www.cognition.ai/devin.

\bibitem{github2024copilot}
GitHub.
\newblock GitHub Copilot Workspace[EB/OL]. (2024). https://github.blog/2024-04-29-github-copilot-workspace.

\bibitem{liu2024agentless}
XIA C S, DENG Y, DUNN S, et al.
\newblock Agentless: Demystifying LLM-based Software Engineering Agents[R]. arXiv:2407.01489, 2024.

\bibitem{liu2024agentbench}
LIU X, YU H, ZHANG H, et al.
\newblock AgentBench: Evaluating LLMs as Agents[C]//Proceedings of ICLR 2024. 2024.

\bibitem{merkel2014docker}
MERKEL D.
\newblock Docker: Lightweight Linux Containers for Consistent Development and Deployment[J]. Linux Journal, 2014(239): 2.

\bibitem{agache2020firecracker}
AGACHE A, BROOKER M, IORDACHE A, et al.
\newblock Firecracker: Lightweight Virtualization for Serverless Applications[C]//Proceedings of USENIX NSDI 2020. 2020: 419--434.

\bibitem{wang2025aptl}
王馨悦, 张玉清, 李明哲.
\newblock 用于验证多智能体系统的APTL模型检测器[J]. 软件学报, 2025, 36(5): 1--25.

\bibitem{replit2024}
Replit.
\newblock Replit Agent: Build and Deploy Software with Natural Language[EB/OL]. (2024). https://replit.com.

\bibitem{codesandbox2024}
CodeSandbox.
\newblock CodeSandbox SDK: Programmatically Start AI Sandboxes[EB/OL]. (2024). https://codesandbox.io.

\bibitem{uv2024}
Astral.
\newblock uv: An Extremely Fast Python Package Manager[EB/OL]. (2024). https://github.com/astral-sh/uv.

\bibitem{poetry2024}
Poetry.
\newblock Python Packaging and Dependency Management Made Easy[EB/OL]. (2024). https://python-poetry.org.

\bibitem{pip2024}
PyPA.
\newblock pip: The Python Package Installer[EB/OL]. (2024). https://pip.pypa.io.

\bibitem{pypi2024}
Python Software Foundation.
\newblock Python Package Index (PyPI)[EB/OL]. (2024). https://pypi.org.

\bibitem{pypa2024setuptools}
PyPA.
\newblock setuptools: Build System for Python Packages[EB/OL]. (2024). https://setuptools.pypa.io.

\bibitem{pypa2024twine}
PyPA.
\newblock twine: Utilities for Interacting with PyPI[EB/OL]. (2024). https://twine.readthedocs.io.

\bibitem{pep508}
COGHLAN N, STUFFT D.
\newblock PEP 508: Dependency Specification for Python Software Packages[S]. Python Enhancement Proposal, 2015.

\bibitem{pep517}
CANNON B, SMITH N, STUFFT D.
\newblock PEP 517: A Build-system Independent Format for Source Trees[S]. Python Enhancement Proposal, 2017.

\bibitem{pythonast2024}
Python Software Foundation.
\newblock ast --- Abstract Syntax Trees[EB/OL]. (2024). https://docs.python.org/3/library/ast.html.

\bibitem{anthropic2025mcp}
Anthropic.
\newblock Model Context Protocol (MCP) Specification[EB/OL]. (2025). https://modelcontextprotocol.io.

\bibitem{anthropic2025skillsystem}
Anthropic.
\newblock Claude Code Skill System[EB/OL]. (2025). https://docs.anthropic.com/en/docs/claude-code.

\bibitem{cline2024}
Cline.
\newblock Cline: AI Coding Agent for VS Code[EB/OL]. (2024). https://github.com/cline/cline.

\bibitem{venv2023}
Python Software Foundation.
\newblock venv --- Creation of Virtual Environments[EB/OL]. (2023). https://docs.python.org/3/library/venv.html.

\bibitem{subprocess2024}
Python Software Foundation.
\newblock subprocess --- Subprocess Management[EB/OL]. (2024). https://docs.python.org/3/library/subprocess.html.

\bibitem{openai2024pricing}
OpenAI.
\newblock OpenAI API Pricing[EB/OL]. (2024). https://openai.com/api/pricing.

\bibitem{anthropic2024pricing}
Anthropic.
\newblock Anthropic API: Pricing and Tokens[EB/OL]. (2024). https://docs.anthropic.com/en/api.

\bibitem{cox2019dependency}
COX R.
\newblock Surviving Software Dependencies[J]. Communications of the ACM, 2019, 62(9): 36--43.

\bibitem{qiao2024taskweaver}
QIAO B, LI L, ZHANG X, et al.
\newblock TaskWeaver: A Code-First Agent Framework[R]. arXiv:2311.17541, 2024.

\bibitem{li2024fullstack}
LI A, ZHANG G, ZHU H, et al.
\newblock FullStack Bench: Evaluating LLMs as Full Stack Coders[R]. arXiv:2412.00535, 2024.

\bibitem{bouzenia2024execution}
BOUZENIA I, PRADEL M.
\newblock You Name It, I Run It: An LLM Agent to Execute Tests of Arbitrary Projects[R]. arXiv:2406.18910, 2024.

...
\textbf{任务设计}：15个Benchmark任务分为三类：（a）普遍包（4个）——仅需numpy/pandas/matplotlib/requests/pyyaml；（b）B2覆盖包（5个）——需scipy/sklearn/bs4/openpyxl/pillow；（c）B2盲区包（6个）——需wordcloud/faker/pendulum/qrcode/loguru/tenacity，B1和B2均失败。

...
OpenAI.
 Code Interpreter[EB/OL]. (2023). https://platform.openai.com/docs/assistants/tools/code-interpreter.

\bibitem{e2b2024}
E2B.
 Secure Sandboxed Cloud Environments for AI Agents[EB/OL]. (2024). https://e2b.dev/docs.

\bibitem{openinterpreter2023}
Killian L.
 Open Interpreter: Let Language Models Run Code on Your Computer[EB/OL]. (2023). https://github.com/OpenInterpreter/open-interpreter.

\bibitem{autogpt2024}
Significant Gravitas.
 AutoGPT: Build and Use AI Agents[EB/OL]. (2024). https://github.com/Significant-Gravitas/AutoGPT.

\bibitem{anthropic2025claude}
Anthropic.
 Claude Code: An Agentic Coding Tool[EB/OL]. (2025). https://docs.anthropic.com/en/docs/claude-code.

\bibitem{google2024aistudio}
Google.
 Google AI Studio: Code Execution Overview[EB/OL]. (2024). https://aistudio.google.com.
...
GAUTHIER P.
 Aider: AI Pair Programming in Your Terminal[EB/OL]. (2024). https://github.com/Aider-AI/aider.

\bibitem{cognition2024devin}
Cognition AI.
 Devin: The First AI Software Engineer[EB/OL]. (2024). https://www.cognition.ai/devin.

\bibitem{github2024copilot}
GitHub.
 GitHub Copilot Workspace[EB/OL]. (2024). https://github.blog/2024-04-29-github-copilot-workspace.
...
\bibitem{replit2024}
Replit.
 Replit Agent: Build and Deploy Software with Natural Language[EB/OL]. (2024). https://replit.com.

\bibitem{codesandbox2024}
CodeSandbox.
 CodeSandbox SDK: Programmatically Start AI Sandboxes[EB/OL]. (2024). https://codesandbox.io.

\bibitem{uv2024}
Astral.
 uv: An Extremely Fast Python Package Manager[EB/OL]. (2024). https://github.com/astral-sh/uv.

\bibitem{poetry2024}
Poetry.
 Python Packaging and Dependency Management Made Easy[EB/OL]. (2024). https://python-poetry.org.

\bibitem{pip2024}
PyPA.
 pip: The Python Package Installer[EB/OL]. (2024). https://pip.pypa.io.

\bibitem{pypi2024}
Python Software Foundation.
 Python Package Index (PyPI)[EB/OL]. (2024). https://pypi.org.

\bibitem{pypa2024setuptools}
PyPA.
 setuptools: Build System for Python Packages[EB/OL]. (2024). https://setuptools.pypa.io.

\bibitem{pypa2024twine}
PyPA.
 twine: Utilities for Interacting with PyPI[EB/OL]. (2024). https://twine.readthedocs.io.
...
Python Software Foundation.
 ast --- Abstract Syntax Trees[EB/OL]. (2024). https://docs.python.org/3/library/ast.html.

\bibitem{anthropic2025mcp}
Anthropic.
 Model Context Protocol (MCP) Specification[EB/OL]. (2025). https://modelcontextprotocol.io.

\bibitem{anthropic2025skillsystem}
Anthropic.
 Claude Code Skill System[EB/OL]. (2025). https://docs.anthropic.com/en/docs/claude-code.

\bibitem{cline2024}
Cline.
 Cline: AI Coding Agent for VS Code[EB/OL]. (2024). https://github.com/cline/cline.

\bibitem{venv2023}
Python Software Foundation.
 venv --- Creation of Virtual Environments[EB/OL]. (2023). https://docs.python.org/3/library/venv.html.

\bibitem{subprocess2024}
Python Software Foundation.
 subprocess --- Subprocess Management[EB/OL]. (2024). https://docs.python.org/3/library/subprocess.html.

\bibitem{openai2024pricing}
OpenAI.
 OpenAI API Pricing[EB/OL]. (2024). https://openai.com/api/pricing.

\bibitem{anthropic2024pricing}
Anthropic.
 Anthropic API: Pricing and Tokens[EB/OL]. (2024). https://docs.anthropic.com/en/api.

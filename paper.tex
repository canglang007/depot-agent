...
\label{tab:modern}
\small
\begin{tabular}{@{}p{2.0cm} p{2.4cm} p{1.8cm} p{1.8cm}@{}}
\toprule
系统 & 依赖处理 & 所属范式 & 预分析? \\
\midrule
...
\subsection{核心创新点}
\textbf{创新1：依赖感知管道（架构创新）。} 在Agent提交代码与执行代码之间插入自动化依赖管理层，如同GC之于内存管理。
...
Token总消耗 & 18,900 & 15,600 & \textbf{11,500} \\
...
如表\ref{tab:overall}所示，Depot在成功率（93\% vs 40\%, 60\%）、Token消耗（-39\%, -26\%）、对话轮次（-37\%, -28\%）三个核心指标上全面最优。
...
\textbf{Depot} & \textbf{11,500} & 14$\times$700 + 1$\times$1,700 \\
\bottomrule
\end{tabular}
\end{table}

Depot的11,500 tokens中14个任务（700/任务）一次成功，仅1个故障任务消耗了1,700 tokens完成修复。而B1的18,900 tokens中有15,300（81\%）浪费在机械性的依赖修复上——这些Token不产生任何代码质量提升。基于LLM API定价\cite{openai2024pricing,anthropic2024pricing}，在15个任务的规模上Depot比B1节省39\%使用成本。
...
在Docker严格隔离环境中的15个Benchmark实验系统验证了Depot的有效性：相比B1裸执行（代表Open Interpreter/AutoGPT范式），Token节省39\%，首次成功率从40\%提升至93\%；相比B2预装方案（代表OpenAI Code Interpreter/E2B范式，42包/1,057MB），处理了5/6的盲区任务，Token节省26\%，基础设施零成本。实验数据独立验证了三个Gap的存在及Depot的针对性解决效果。
...
OpenAI.
 Code Interpreter[EB/OL]. (2023). \url{https://platform.openai.com/docs/assistants/tools/code-interpreter}.

\bibitem{e2b2024}
E2B.
 Secure Sandboxed Cloud Environments for AI Agents[EB/OL]. (2024). \url{https://e2b.dev/docs}.

\bibitem{openinterpreter2023}
Killian L.
 Open Interpreter: Let Language Models Run Code on Your Computer[EB/OL]. (2023). \url{https://github.com/OpenInterpreter/open-interpreter}.

\bibitem{autogpt2024}
Significant Gravitas.
 AutoGPT: Build and Use AI Agents[EB/OL]. (2024). \url{https://github.com/Significant-Gravitas/AutoGPT}.

\bibitem{anthropic2025claude}
Anthropic.
 Claude Code: An Agentic Coding Tool[EB/OL]. (2025). \url{https://docs.anthropic.com/en/docs/claude-code}.

\bibitem{google2024aistudio}
Google.
 Google AI Studio: Code Execution Overview[EB/OL]. (2024). \url{https://aistudio.google.com}.

\bibitem{jimenez2024sweagent}
YANG J, JIMENEZ C E, WETTIG A, et al.
 SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering[C]//Proceedings of NeurIPS 2024. 2024.

\bibitem{yang2024swebench}
JIMENEZ C E, YANG J, WETTIG A, et al.
 SWE-bench: Can Language Models Resolve Real-World GitHub Issues?[C]//Proceedings of ICLR 2024. 2024.

\bibitem{guo2024aider}
GAUTHIER P.
 Aider: AI Pair Programming in Your Terminal[EB/OL]. (2024). \url{https://github.com/Aider-AI/aider}.

\bibitem{cognition2024devin}
Cognition AI.
 Devin: The First AI Software Engineer[EB/OL]. (2024). \url{https://www.cognition.ai/devin}.

\bibitem{github2024copilot}
GitHub.
 GitHub Copilot Workspace[EB/OL]. (2024). \url{https://github.blog/2024-04-29-github-copilot-workspace}.

\bibitem{liu2024agentless}
XIA C S, DENG Y, DUNN S, et al.
 Agentless: Demystifying LLM-based Software Engineering Agents[R]. arXiv:2407.01489, 2024.

\bibitem{liu2024agentbench}
LIU X, YU H, ZHANG H, et al.
 AgentBench: Evaluating LLMs as Agents[C]//Proceedings of ICLR 2024. 2024.

\bibitem{merkel2014docker}
MERKEL D.
 Docker: Lightweight Linux Containers for Consistent Development and Deployment[J]. Linux Journal, 2014(239): 2.

\bibitem{agache2020firecracker}
AGACHE A, BROOKER M, IORDACHE A, et al.
 Firecracker: Lightweight Virtualization for Serverless Applications[C]//Proceedings of USENIX NSDI 2020. 2020: 419--434.

\bibitem{wang2025aptl}
王馨悦, 张玉清, 李明哲.
 用于验证多智能体系统的APTL模型检测器[J]. 软件学报, 2025, 36(5): 1--25.

\bibitem{replit2024}
Replit.
 Replit Agent: Build and Deploy Software with Natural Language[EB/OL]. (2024). \url{https://replit.com}.

\bibitem{codesandbox2024}
CodeSandbox.
 CodeSandbox SDK: Programmatically Start AI Sandboxes[EB/OL]. (2024). \url{https://codesandbox.io}.

\bibitem{uv2024}
Astral.
 uv: An Extremely Fast Python Package Manager[EB/OL]. (2024). \url{https://github.com/astral-sh/uv}.

\bibitem{poetry2024}
Poetry.
 Python Packaging and Dependency Management Made Easy[EB/OL]. (2024). \url{https://python-poetry.org}.

\bibitem{pip2024}
PyPA.
 pip: The Python Package Installer[EB/OL]. (2024). \url{https://pip.pypa.io}.

\bibitem{pypi2024}
Python Software Foundation.
 Python Package Index (PyPI)[EB/OL]. (2024). \url{https://pypi.org}.

\bibitem{pypa2024setuptools}
PyPA.
 setuptools: Build System for Python Packages[EB/OL]. (2024). \url{https://setuptools.pypa.io}.

\bibitem{pypa2024twine}
PyPA.
 twine: Utilities for Interacting with PyPI[EB/OL]. (2024). \url{https://twine.readthedocs.io}.

\bibitem{pep508}
COGHLAN N, STUFFT D.
 PEP 508: Dependency Specification for Python Software Packages[S]. Python Enhancement Proposal, 2015.

\bibitem{pep517}
CANNON B, SMITH N, STUFFT D.
 PEP 517: A Build-system Independent Format for Source Trees[S]. Python Enhancement Proposal, 2017.

\bibitem{pythonast2024}
Python Software Foundation.
 ast --- Abstract Syntax Trees[EB/OL]. (2024). \url{https://docs.python.org/3/library/ast.html}.

\bibitem{anthropic2025mcp}
Anthropic.
 Model Context Protocol (MCP) Specification[EB/OL]. (2025). \url{https://modelcontextprotocol.io}.

\bibitem{anthropic2025skillsystem}
Anthropic.
 Claude Code Skill System[EB/OL]. (2025). \url{https://docs.anthropic.com/en/docs/claude-code}.

\bibitem{cline2024}
Cline.
 Cline: AI Coding Agent for VS Code[EB/OL]. (2024). \url{https://github.com/cline/cline}.

\bibitem{venv2023}
Python Software Foundation.
 venv --- Creation of Virtual Environments[EB/OL]. (2023). \url{https://docs.python.org/3/library/venv.html}.

\bibitem{subprocess2024}
Python Software Foundation.
 subprocess --- Subprocess Management[EB/OL]. (2024). \url{https://docs.python.org/3/library/subprocess.html}.

\bibitem{openai2024pricing}
OpenAI.
 OpenAI API Pricing[EB/OL]. (2024). \url{https://openai.com/api/pricing}.

\bibitem{anthropic2024pricing}
Anthropic.
 Anthropic API: Pricing and Tokens[EB/OL]. (2024). \url{https://docs.anthropic.com/en/api}.

\bibitem{cox2019dependency}
COX R.
 Surviving Software Dependencies[J]. Communications of the ACM, 2019, 62(9): 36--43.

\bibitem{qiao2024taskweaver}
QIAO B, LI L, ZHANG X, et al.
 TaskWeaver: A Code-First Agent Framework[R]. arXiv:2311.17541, 2024.

\bibitem{li2024fullstack}
LI A, ZHANG G, ZHU H, et al.
 FullStack Bench: Evaluating LLMs as Full Stack Coders[R]. arXiv:2412.00535, 2024.

\bibitem{bouzenia2024execution}
BOUZENIA I, PRADEL M.
 You Name It, I Run It: An LLM Agent to Execute Tests of Arbitrary Projects[R]. arXiv:2406.18910, 2024.
